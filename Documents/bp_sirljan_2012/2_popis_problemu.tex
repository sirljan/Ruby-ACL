...
Oracle má nejpropracovanější model řízení práv. Podporuje integrování LDAP\footnote[1]{Lightweight Directory Access Protocol} a WebDAV\footnote[2]{Web-based Distributed Authoring and Versioning}.
