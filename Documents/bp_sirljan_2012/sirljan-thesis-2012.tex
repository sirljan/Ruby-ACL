...
Kapitole 6 je rozdělená na dvě části. Jedna se zabýva pomocným komunikačním rozhraním eXistAPI a druhá samotnou knihovnou Ruby-ACL. Obě části jsou však zaměřeny vysvětlení způsobu testování a jejich výsledky.

Kapitola 7 se zaměřuje na zhodnocení splnění cílů Bakalářské práce a rozebírá možné nedostatky a případné pokračování v práci na knihovně.
...
TODO přidat obrázek s model tříd k API.

\subsubsection{RubyACL > DB}
