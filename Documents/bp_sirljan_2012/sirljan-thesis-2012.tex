...
% Úvod
\include{1_uvod}
TODO jak vizualně oddělovat metody, třídy adresy názvy souborů. apod. napr \verb|("/db/cities/cities.xml")/cities|
V podstatě, které slova by měly být graficky (fontem) rozlišeny.
